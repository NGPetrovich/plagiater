...
const Book = props => {
    ...
    return (
        <div>
            ...
            {!selection.table.id ? (<div id="reservation-stuff">
                <Row className="text-center align-items-center row g-0">
                    <Col xs="12" sm="3">
                        <input type = "date"
                        required="required"
                ...
                <Row className="table-display row g-0">
                    <Col>
                        {getEmptyTables() > 0 ? (
                        ...
                        {selection.date && selection.time ? (
                            getEmptyTables() > 0 ? (
                                <div>
                                    ...
                                    <Row className="row g-0">{getTables()}</Row>
                                </div>
                            ) : (
                ...
                <div id="confirm-reservation-stuff">
                    <Row
                        className="text-center justify-content-center reservation-details-container row g-0"
                    >
                    ...
                    <Row className="text-center row g-0">
                        <Col>
                        <Button
                            color="none"
